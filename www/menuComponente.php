...
<body >
  <div class="quadro">
      ...
      <div class="centro">
          <div class="row">
              <div class="col-md-2">
                  <button type="submit" class="cadastrarComponente btnEstilo">CADASTRAR</button>
              </div>
              <div class="col-md-9">
  ...
  <div class="modal fade" id="modalCadastroComponente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
              ...
              <div class="form-group">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="hour" class="cadastrarCargaComponente form-control" placeholder="Ex: 120">
                      </div>
                  </div>

                  <div class="row">
                    <div class="col-md-12">
                        <label for="">Módulo Pertencente: </label>
                        <select name="" id="" class="cadastrarModuloComponente form-control">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <select name="" id="" class=" optionLocalComponente cadastrarLocalComponente form-control">
                          </select>
                      </div>
                  </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btnEstilo btnCadastrarComponente">CADASTRAR COMPONENTE</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modalAlterarComponente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
              <div class="form-group">
                  <div class="row">
                      <div class="col-md-12">
                          <label for="">Nome</label>
                          <input type="text" class="alterarNmComponente form-control" placeholder="Ex: Tratamento de Gestantes">
                      </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="alterarCodigoComponente form-control" disabled>
                    </div>
                </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <label for="">Carga Horária</label>
                          <input type="hour" class="alterarCargaComponente form-control" placeholder="Ex: 120">
                      </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <label for="">Módulo Pertencente: </label>
                        <select name="" id="" class="alterarModuloComponente form-control">
                            <option value="2">2 Módulo</option>
                            <option value="4">4 Módulo</option>
                        </select>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <select type="text" id="alterarStatusComponente" class=" form-control">
              ...
              <div class="row">
                      <div class="col-md-12">
                          <label for="">Local de Estágio</label>
                          <select name="" id="" class=" optionLocalComponente alterarLocalComponente form-control">
                          </select>
                      </div>
             </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btnEstilo btnAlterarComponente">ALTERAR COMPONENTE</button>
          </div>
        </div>
      </div>
    </div>
