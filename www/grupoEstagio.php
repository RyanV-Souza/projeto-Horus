...
<head>
  ...
  <link rel="stylesheet" href="templates/css/grupo.css" /> 
...
<body >
  ...
  <!--Modal Cadastro-->
  <div class="modal fade" id="modalCadastroGrupo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
              ...
              <div class="form-group">
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" class="form-control cadastrarNmGrupo" placeholder="Ex: Grupo A">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" class="form-control cadastrarSiglaGrupo" placeholder="Ex: GP-A">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="blocoAlunos">
                            <div class="divisaoGrupoAluno">
                              <input type="checkbox" name="" id=""> <label for="">Oi</label>
                            </div>
                            <div class="divisaoGrupoAluno">
                              <input type="checkbox" name="" id=""> <label for="">Oi</label>
                            </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btnEstilo btnCadastrarGrupo">CADASTRAR GRUPO</button>
          </div>
        </div>
      </div>
    </div>
