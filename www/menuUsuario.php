...
<body >
  <div class="quadro">
      ...
      <div class="centro">
          <div class="row">
              <div class="col-md-2">
                  <button type="submit" class="cadastrarUsuario btnEstilo">CADASTRAR</button>
              </div>
              <div class="col-md-9">
  ...
  <div class="modal fade" id="modalCadastroUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
              ...
              <div class="form-group">
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" id="cadastrarNmUsuario" class=" form-control" placeholder="Ex: Pedro Henrique Gomes">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" id="cadastrarRmUsuario" class=" form-control" placeholder="Ex: 0000">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <label for="">E-Mail</label>
                          <input type="text" id="cadastrarEmailUsuario" class=" form-control" placeholder="Ex: pedro@gmail.com.br">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <label for="">CPF</label>
                          <input type="text" id="cadastrarCPFUsuario" class="form-control cpfMask" placeholder="Ex: 000.000.000-00">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <select type="text" id="cadastrarCargoUsuario" class=" form-control">
          ...
          <div class="modal-footer">
            <button type="button" class="btnEstilo btnCadastrarUsuario">CADASTRAR USUÁRIO</button>
          </div>
        </div>
      </div>
    </div>
     ...
     <!--Modal Alterar-->
  <div class="modal fade" id="modalAlterarUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <label for="">Nome</label>
                        <input type="text" id="alterarNmUsuario" class=" form-control" placeholder="Ex: Pedro Henrique Gomes">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label for="">Registro de Matrícula</label>
                        <input type="text" id="alterarRmUsuario" class=" form-control" placeholder="Ex: 0000" disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label for="">E-Mail</label>
                        <input type="text" id="alterarEmailUsuario" class=" form-control" placeholder="Ex: pedro@gmail.com.br">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select type="text" id="alterarStatusUsuario" class=" form-control">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label for="">Cargo</label>
                        <select type="text" id="alterarCargoUsuario" class=" form-control">
                            <option value="1">Coordenador</option>
                            <option value="2">Professor</option>
        ...
        <div class="modal-footer">
          <button type="button" class="btnEstilo btnAlterarUsuario">ALTERAR USUÁRIO</button>
        </div>
      </div>
    </div>
  </div>
